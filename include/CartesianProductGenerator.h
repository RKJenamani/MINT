...
public:
	...
	void explicitCPG(Graph & g1, int dim1, Graph &g2, int dim2, Graph &new_map)
	{
		...
		std::map<Eigen::VectorXd,Vertex, std::function<bool(const Eigen::VectorXd&,const Eigen::VectorXd&)> > configToNodeMap([](const Eigen::VectorXd & a, const Eigen::VectorXd & b)->bool
  		{
